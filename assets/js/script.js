...
const questions = [
    ...
    answer: [
        {option: "15kg", correct: false},
        {option: "20kg", correct: false},
        {option: "25kg", correct: true},
        {option: "30kg", correct: false}
        ]
    },
    ...
    answer: [
        {option: "The colour of the box.", correct: false},
        {option: "Check the weight, and shape of the load.", correct: true},
        {option: "If the box has the delivery details on it.", correct: false},
        {option: "Check out what is in the box", correct: false}
        ]
    },

    {question: "Which part of your body are you most likely to injure if you lift heavy loads",
    answer: [
        {option: "Your back", correct: true},
        {option: "Your knees", correct: false},
        {option: "Your legs", correct: false},
        {option: "Your neck", correct: false}
        ]
    },

    {question: "If a staff member discovers she is pregnant, should she…",
    answer: [
        {option: "Hide this for as long as possible, but avoid heavy lifting.", correct: false},
        {option: "Tell her colleagues, so they can help her incase she needs to lift something heavy.", correct: false},
        {option: "Tell the supervisor so they can conduct a risk assessment, create a safer environment and safer tasks for the pregnant employee.", correct: true},
        {option: "Continue as normal.", correct: false}
        ]
    },
    ...
    answer: [
        {option: "Pick up the load and run to move it faster.", correct: false},
        {option: "Use a fork-lift, even though you have no training on how to use one.", correct: false},
        {option: "Drag the load on the ground.", correct: false},
        {option: "Do not attempt to move the load unless you find a safe way to move it.", correct: true}
        ]
    },

    {question: "How should you position yourself if you need to lift a load from the ground?",
    answer: [
        {option: "Feet as wide as possible, legs bent, back bent.", correct: false},
        {option: "Feet slightly apart, legs straight, back bent.", correct: false},
        {option: "Feet slightly apart, legs bent, back straight.", correct: true},
        {option: "Feet close together, legs bent, back straight. ", correct: false}
        ]
    },

    {question: "Who should decide what weight is safe for you to lift in your work environment?",
    answer: [
        {option: "Your supervisor", correct: false},
        {option: "You and your supervisor", correct: false},
        {option: "You", correct: true},
        {option: "The Health and Safety Authority of Ireland (HSA)", correct: false}
        ]
    },

    {question: "You need to move a load which is heavier on one side than the other. How do you pick it up?",
    answer: [
        {option: "With the heavier side away from you.", correct: false},
        {option: "With the heavier side on your strong arm.", correct: false},
        {option: "With the heavier side on your weak arm.", correct: false},
        {option: "With the heavier side towards you.", correct: true},
        ]
    }
]
